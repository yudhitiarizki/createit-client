    ...
    return (
        <div className='navbar-cntr'>
            ...
            <div className='navbar-right'>
                <div className='navbarright-item'><Link to='/' className="nav-link">Home</Link></div>

                <div className='dropdown me-1 navbarright-item'>
                ...
                <div type="button" className='navbarright-item'>About</div>

                {(isLoggedIn) ? (
                    <div className='dropdown me-1'>
                        <div type="button" id="dropdownMenuOffset3" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="100%,20">
                            <img src={Ellipse2} alt=''></img>
                        </div>
                        <ul className="dropdown-menu cat-list" aria-labelledby="dropdownMenuOffset3">
                            {(user.role === 3) ? (
                                <>
                    ...
                    <div type="button" className='navbarright-item'><Link to='/login' className="nav-link">Login</Link></div>
                )}
            </div>
        </div>
    )
